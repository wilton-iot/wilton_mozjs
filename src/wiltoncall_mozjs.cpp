...
std::shared_ptr<support::script_engine_map<mozjs_engine>> shared_tlmap() {
    static auto tlmap = std::make_shared<support::script_engine_map<mozjs_engine>>();
    return tlmap;
}
...
extern "C" char* wilton_module_init() {
    try {
        ...
        wilton::support::register_wiltoncall("runscript_mozjs", wilton::mozjs::runscript);
        wilton::support::register_wiltoncall("rungc_mozjs", wilton::mozjs::rungc);
        return nullptr;
